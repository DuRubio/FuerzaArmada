...
public class TestCases {
	...
	public void queSePuedaCrearUnaBatalla() {
		...
		assertEquals((Double)100.5, argentina.getBatalla("San Lorenzo").getLatitud());
		assertEquals((Double)20.3, argentina.getBatalla("San Lorenzo").getLongitud());
	...
	@Test
	public void queSePuedaEnviarAUnaBatallaEnTierraUnCamion() throws VehiculoInexistente, VehiculoIncompatible { //test agregado por mi
		FuerzaArmada argentina = new FuerzaArmada();
	...
	public void queNoSePuedaEnviarAUnaBatallaUnVehiculoQueNoExista() throws VehiculoInexistente, VehiculoIncompatible {
		FuerzaArmada argentina = new FuerzaArmada();
